...
La práctica consiste en estudiar y crear una **guía de estilo** para tu aplicación desarrollada en la anterior unidad rellenando un documento adjunto para seguir algunas de las reglas básicas de **usabilidad** vistas. Deberás de personalizar y reorganizar su diseño, la barra superior y mediante paneles la aplicación para darle así un aspecto visual más acorde y actual:
